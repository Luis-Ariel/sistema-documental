...
namespace SistemaDocumental.Core.Entities
{
    public class CentroCostos
    {
        ...
        public virtual ICollection<Oficina> OficinasRelacionadas { get; set; } = new List<Oficina>();

        // Relación 1-N: Un centro de costos puede estar asignado a múltiples usuarios
        public virtual ICollection<Usuario> UsuariosRelacionados { get; set; } = new List<Usuario>();
